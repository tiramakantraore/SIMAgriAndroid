...
* SIMAgri is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as SIMAgri is mean to act as a starting point for Android Applications.

# SIMAgri App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-tiramkanforce.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-tiramkanforce)

This repository contains the source code for the [SIMAgri](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.tiramkanForce).

Please see the [issues](https://github.com.tiramkanForce/com-tiramkanforce/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about SIMAgri? Ask away on the [com-tiramkanforce discussion forum](https://groups.google.com/forum/#!forum/com-tiramkanforce).

<a href="https://play.google.com/store/apps/details?id=com.tiramkanForce" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.tiramkanForce__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.tiramkanForce__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.tiramkanForce.R__) will now be renamed
...
SIMAgri is a result of a template project I've developed over the years as well as
...
SIMAgri is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.tiramkanForce/com-tiramkanforce/contributors) on
...
[pull requests](https://github.com.tiramkanForce/com-tiramkanforce/pulls).
