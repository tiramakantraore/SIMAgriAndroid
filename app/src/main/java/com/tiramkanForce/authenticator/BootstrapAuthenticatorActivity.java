package com.tiramkanForce.authenticator;
...
import com.tiramkanForce.R.id;
import com.tiramkanForce.R.layout;
import com.tiramkanForce.R.string;
import com.tiramkanForce.core.BootstrapService;
import com.tiramkanForce.core.Constants;
import com.tiramkanForce.core.User;
import com.tiramkanForce.events.UnAuthorizedErrorEvent;
import com.tiramkanForce.ui.TextWatcherAdapter;
import com.tiramkanForce.util.SafeAsyncTask;
import com.tiramkanForce.util.Toaster;
...
public class BootstrapAuthenticatorActivity extends ActionBarAccountAuthenticatorActivity {
    ...
    @Inject BootstrapServiceProvider bootstrapServiceProvider;
    @Inject Bus bus;
    ...
    public void handleLogin(final View view) {
       ...
       //         User loginResponse = bootstrapServiceProvider.getService().authenticate(email, password);
