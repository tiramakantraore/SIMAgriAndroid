...
import com.tiramkanForce.core.PauseTimerEvent;
import com.tiramkanForce.core.ResumeTimerEvent;
import com.tiramkanForce.core.StopTimerEvent;
import com.tiramkanForce.core.TimerPausedEvent;
import com.tiramkanForce.core.TimerService;
import com.tiramkanForce.core.TimerTickEvent;
import com.tiramkanForce.core.User;
import com.tiramkanForce.util.TimeUtil;
...
public class BootstrapTimerActivity extends BootstrapFragmentActivity implements View.OnClickListener {
    ...
    private void loadUsers(){
        try {
            serviceProvider.getService().importUsersFromServer();
            RealmResults<User> users = serviceProvider.getService().getUsers();
            users.sort("fullName", Sort.ASCENDING);
            Toast.makeText(getApplicationContext(), " Liste des utilisateurs "+users, Toast.LENGTH_LONG).show();

        }catch (Exception ex){
            Toast.makeText(getApplicationContext(), "Cause: " + ex.getMessage(), Toast.LENGTH_LONG).show();
